export const storeObjects = [
  ...
  },
  {
    id : 'MediaCollection',
    conditions : (module) =>
        module.default && module.default.prototype &&
  ...
  {
    id : 'WapDelete',
    conditions : (module) => module.sendConversationDelete &&
  ...
  {
    id : 'WapQuery',
    conditions : (module) => module.queryExist
                                 ? module
  ...
  {
    id : 'OpenChat',
    conditions : (module) => module.default && module.default.prototype &&
  ...
  },
  {
    id : 'bp',
    conditions : (module) =>
        module.default && module.default.toString().includes(
                              'binaryProtocol deprecated version')
            ? module.default
            : null,
  },
  {
  ...
  },
  {
    id : 'Builders',
    conditions : (module) =>
        module.TemplateMessage && module.HydratedFourRowTemplate ? module
                                                                 : null,
  },
  {
    id : 'Me',
  ...
  {
    id : 'ChatStates',
    conditions : (module) => module.sendChatStatePaused &&
  ...
  {
    id : 'WebMessageInfo',
    conditions : (module) => module.WebMessageInfo && module.WebFeatures
  ...
  },
  {
    id : 'Participants',
    conditions : (module) =>
        module.addParticipants && module.removeParticipants &&
                module.promoteParticipants && module.demoteParticipants
            ? module
            : null,
  },
  {
  ...
  },
  {
    id : 'Base',
    conditions : (module) =>
        module.setSubProtocol && module.binSend && module.actionNode ? module
                                                                     : null,
  },
  {
    id : 'Base2',
    conditions : (module) =>
        module.supportsFeatureFlags && module.parseMsgStubProto &&
                module.binSend && module.subscribeLiveLocation
            ? module
            : null,
  },
  {
    id : 'Versions',
    conditions : (module) =>
        module.loadProtoVersions && module.default[ '15' ] &&
                module.default[ '16' ] && module.default[ '17' ]
            ? module
            : null,
  },
  {
    id : 'Sticker',
    conditions : (module) => module.default && module.default.Sticker
  ...
  {
    id : 'UploadUtils',
    conditions : (module) => module.default && module.default.encryptAndUpload
                                 ? module.default
                                 : null,
  },
  {
